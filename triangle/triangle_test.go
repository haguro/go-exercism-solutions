...
var testData = []testCase{
	...
	{Iso, 10, 10, 2},  // again
	{Deg, 2, 4, 2},    // a "triangle" that is just a line is still OK (but called degenerate)
	{Sca, 3, 4, 5},    // no sides equal
	{Sca, 10, 11, 12}, // again
	{Sca, 5, 4, 2},    // descending order
	{Sca, .4, .6, .3}, // small sides
	{Deg, 1, 4, 3},    // a "triangle" that is just a line is still OK (but called degenerate)
	{Sca, 5, 4, 6},    // 2a == b+c looks like equilateral, but isn't always.
	{Sca, 6, 4, 5},    // 2a == b+c looks like equilateral, but isn't always.
	{Deg, 4, 3, 7},    // sum of first and second sides equals the third
	{Deg, 2, 2, 4},    // same
	{NaT, 5, 0, 5},    // same as above, but one side has length of zero
